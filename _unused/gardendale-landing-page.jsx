...
export default function Gardendale() {
    ...
    <div style={{ minHeight: "100vh", background: "#FEFDF8", fontFamily: "Georgia, serif" }}>
      <script type="application/ld+json">{`
        {
          ...
          "@type": "LocalBusiness",
          "name": "EnviroCare Pest Control - Gardendale, AL",
          "telephone": "+12059406360",
          "url": "https://envirocarellc.com/gardendale",
          "areaServed": ["Gardendale, AL", "Jefferson County, AL"],
      ...
      <section style={{ padding: "72px 40px", background: "#f7f9f7" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: 28, fontWeight: 400, color: DARK, lineHeight: 1.2, marginBottom: 18 }}>
            Why Gardendale Needs <em style={{ color: G }}>Specialized Care</em>
          </h2>
          <p style={{ fontSize: 15, color: "#4b5563", lineHeight: 1.75, ...sf }}>
            Neighborhoods bordering farmland see mouse and rat migration, especially during harvest season. Wooded lots along Turkey Creek bring tick and spider pressure.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "72px 40px", background: "#FEFDF8" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ fontSize: 28, fontWeight: 400, color: DARK, textAlign: "center", marginBottom: 40 }}>Gardendale <em style={{ color: G }}>Services</em></h2>
      ...
      <section style={{ background: "#f7f9f7", padding: "56px 40px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <h2 style={{ fontSize: 26, fontWeight: 400, color: DARK, marginBottom: 28, textAlign: "center" }}>Gardendale FAQ</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { q: "Do you serve Gardendale regularly?", a: "Yes. Established routes and many residential and commercial accounts." },
              { q: "Seeing mice near the farmland — can you help?", a: "Absolutely. Mouse migration from agricultural areas is common. We provide trapping, exclusion, and monitoring." },
              { q: "How much is pest control in Gardendale?", a: "Same as Birmingham area — quarterly starts at $39/month. New customers get $50 off." },
              { q: "Do you treat the Turkey Creek area?", a: "Yes. Higher mosquito and tick pressure near the waterway." },
            ].map((item, i) => (
      ...
      <section style={{ background: `linear-gradient(160deg, ${G}, #0d3a1a)`, padding: "72px 40px", textAlign: "center", color: "#fff" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          <h2 style={{ fontSize: 36, fontWeight: 400, lineHeight: 1.2, marginBottom: 12 }}>Protect Your<br /><em>Gardendale Home</em></h2>
        ...
        <div onClick={() => setQuoteOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(14,26,15,0.75)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#FEFDF8", borderRadius: 16, width: "100%", maxWidth: 420, overflow: "hidden", boxShadow: "0 30px 80px rgba(0,0,0,0.4)" }}>
            <div style={{ background: G, color: "#fff", padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18 }}>Free Gardendale Inspection</div>
