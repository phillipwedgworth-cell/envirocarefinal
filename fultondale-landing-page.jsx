...
export default function Fultondale() {
    ...
    <div style={{ minHeight: "100vh", background: "#FEFDF8", fontFamily: "Georgia, serif" }}>
      <script type="application/ld+json">{`
        {
          ...
          "@type": "LocalBusiness",
          "name": "EnviroCare Pest Control - Fultondale, AL",
          "telephone": "+12059406360",
          "url": "https://envirocarellc.com/fultondale",
          "areaServed": ["Fultondale, AL", "Jefferson County, AL"],
      ...
      <section style={{ padding: "72px 40px", background: "#f7f9f7" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: 28, fontWeight: 400, color: DARK, lineHeight: 1.2, marginBottom: 18 }}>
            Why Fultondale Needs <em style={{ color: G }}>Specialized Care</em>
          </h2>
          <p style={{ fontSize: 15, color: "#4b5563", lineHeight: 1.75, ...sf }}>
            Older homes near Black Creek face moisture-driven pest pressure. Newer areas deal with fire ants. Commercial properties along the highway need restaurant and retail pest management.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "72px 40px", background: "#FEFDF8" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ fontSize: 28, fontWeight: 400, color: DARK, textAlign: "center", marginBottom: 40 }}>Fultondale <em style={{ color: G }}>Services</em></h2>
      ...
      <section style={{ background: "#f7f9f7", padding: "56px 40px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <h2 style={{ fontSize: 26, fontWeight: 400, color: DARK, marginBottom: 28, textAlign: "center" }}>Fultondale FAQ</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { q: "Is Fultondale in your service area?", a: "Yes. Covered by our Birmingham-area office with regular routes." },
              { q: "My older home near the creek has moisture issues — does that affect pests?", a: "Significantly. Moisture creates ideal conditions for termites, cockroaches, silverfish, and earwigs." },
              { q: "Do you serve Fultondale businesses along I-65?", a: "Yes. Commercial pest control with after-hours service available." },
              { q: "How fast can you get to Fultondale?", a: "Same-day service. About 30 minutes from our Alabaster office." },
            ].map((item, i) => (
      ...
      <section style={{ background: `linear-gradient(160deg, ${G}, #0d3a1a)`, padding: "72px 40px", textAlign: "center", color: "#fff" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          <h2 style={{ fontSize: 36, fontWeight: 400, lineHeight: 1.2, marginBottom: 12 }}>Protect Your<br /><em>Fultondale Home</em></h2>
        ...
        <div onClick={() => setQuoteOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(14,26,15,0.75)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#FEFDF8", borderRadius: 16, width: "100%", maxWidth: 420, overflow: "hidden", boxShadow: "0 30px 80px rgba(0,0,0,0.4)" }}>
            <div style={{ background: G, color: "#fff", padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18 }}>Free Fultondale Inspection</div>
